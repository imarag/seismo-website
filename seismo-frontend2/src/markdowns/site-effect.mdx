...
![Site effect, the amplification of the ground motion due to the underground Geology](/img/site-effect.png)
...
![NEHPR site classification system](/img/nehpr_site_classification.png)
