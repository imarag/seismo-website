...
export default function SiteEffect() {
  return (
    <div>
            ...
            <div>
                <figure>
                    <img src={softnessImage} alt="softness of the geological rocks" />
            ...
            <div>
                <figure>
                    <img src={basinImage} alt="geological basin" />
            ...
            <div>
                <figure>
                    <img src={topographyImage} alt="topographic effects" />
            ...
            <figcaption className="blockquote-footer">
                David M. Boore Journal of Earthquake Engineering Vol. 8 1-41, 2004, <cite title="Source Title">CAN SITE RESPONSE BE PREDICTED?</cite>
            </figcaption>
            ...
            <figcaption className="table-caption">V<sub>s30</sub> Site Classification for Seismic Site Response (NEHPR, 1994)</figcaption>
            ...
            <p>
                ...
                indicator
                alongside V<sub>s30</sub> (<span class="author-ref">Cadet et al. 2012, Luzi et al. 2011</span>). This highlights the
                ...
                is integrated with V<sub>s30</sub> to enhance the accuracy of site response predictions (<span
                    class="author-ref">Baram et al. 2020, Hassani and Atkinson, 2016</span>). Additionally, some
                ...
                and the site fundamental frequency (f<sub>0</sub>) offer the best discrimination of soil characteristics (<span
                    class="author-ref">Cadet et al. 2008</span>).
            ...
            <div>
                <figure>
                    <img src={BedrockSurfaceOutcropMotion}
                        alt="site effect motions in surface and in the bedrock" />
            ...
            <ul>
                <li>
                    <b>a) Equality of eHVSR and mHVSR</b>: There's a question about whether eHVSR and mHVSR are equivalent.
                    ...
                    (Earthquake to Microtremor Ratio) to extract eHVSR information from mHVSR data (<span class="author-ref">Kawase
                        et al. 2018</span>).
                </li>
                <li>
                    <b>b) Relationship between HSAF and eHVSR</b>: It's also important to consider whether HSAF and eHVSR are the
                    same. These
                    may not be identical, but they can be made equal by adjusting the vertical site amplification factor (VSAF) in
                    the
                    denominator of the eHVSR calculation (<span class="author-ref">Ito et al. 2020, Maragkakis et al. 2021</span>).
                </li>
            </ul>
            <p>
            ...
            <h1>H/V ratios from earthquake recordings (eHVSRs)</h1>
                ...
                <p>
                    ...
                    previously
                    developed by <span class="author-ref">Wesley (1982)</span>, as well as the work of <span
                        class="author-ref">Sánchez-Sesma et al. 2008, 2011</span>, and <span class="author-ref">Kawase et al.
                        2011</span>. This
                ...
                <p>
                    ...
                    function (VACF).
                    <span class="author-ref">Eri Ito (2020) and their colleagues</span> applied this method, in their research paper
                    ...
                    seismic recordings
                    in Japan. Similarly, <span class="author-ref">Maragkakis (2021) and their research team </span> employed the
                ...
                <div>
                    <figure>
                        <img src={RayPaths300} alt="ray paths map Greece" />
                ...
                <div>
                    <figure>
                        <img src={ItoMineMeanVacf} alt="site effect image" />
                ...
                <div>
                    <figure>
                        <img src={CategorizedVacfsMine} alt="site effect image" />
                ...
                <div>
                    <figure>
                        <img src={VacfSSRHVSRSTC} alt="site effect image" />
                ...
                <div>
                    <figure>
                        <img src={VacfSSRHVSRSTE} alt="site effect image" />
                        <figcaption>Comparison of the corrected amplification curve (blue curve) with the SSR (black curve) using
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">Ito, E. et al. (2020) “A Method to Directly Estimate S -Wave Site Amplification
                    ...
                    <li class="list-group-item">Kawase, H., Mori, Y. and Nagashima, F. (2018) “Difference of horizontal-to-vertical
                    ...
                    <li class="list-group-item">Luzi, L. et al. (2011) “Proposal for a soil classification based on parameters
                    ...
                    <li class="list-group-item">Nagashima, F., Kawase, H. and Matsushima, S. (2017) “ESTIMATION OF HORIZONTAL
                    ...
                    <li class="list-group-item">BOORE, D.M. (2004) “CAN SITE RESPONSE BE PREDICTED?,” Journal of Earthquake
                        Engineering, 8(sup001), pp. 1–41. doi:10.1080/13632460409350520.</li>
                    <li class="list-group-item">Baram, A., Yagoda-Biran, G. and Kamai, R. (2020) “Evaluating Proxy-Based Site
