...
![tectonic plates](tectonic-plates.png)
*Most earthquakes are concentrated at the edges of the tectonic plates that consitute the lithosphere of the Earth*
...
![seismic fault](fault-animation.gif)
*Generation of an earthquake by a sudden release of enery of an active seismic fault*
...
![Propagation of P waves](p-waves.gif)
...
![Propagation of SH waves](sh-waves.gif)
*Propagation of SH waves*

![Propagation of SV waves](sv-waves.gif)
*Propagation of SV waves*
...
![Propagation of Love Waves](love-waves.gif)
*Propagation of Love Waves*

![Propagation of Rayleigh Waves](rayleigh-waves.gif)
...
![Seismic waves generation](source-medium-station.png)
*Seismic waves are generated at a source or focus, travel through the earth medium and are recorded at a receiver or seismometer at the surface.*
...
![seismic phases](seismic-phases.png) 
*Various seismic phases generated from the interactions of the body waves and the earth's interior layers*
...
![A fault is assumed to be a planar surface](fault-type-general.png)
*A fault is assumed to be a planar surface. The block located above the fault plane is called the hanging wall and the block below, the footwall*
...
![The geometry of a seismic fault](fault-geometry.png)
*The geometry of a seismic fault*
...
![Normal slip faulting](normal-slip-fault.gif)
*Normal slip faulting. The hanging wall moves downwards relative to the foot wall in which the slip angle is 270 degrees*
...
![Reverse slip faulting](reverse-slip-fault.gif)
*Reverse slip faulting. The hanging wall moves upwards relative to the foot wall in which the slip angle is 90 degrees*
...
![Left-lateral strike-slip fault](strike-slip-fault.gif)
*Left-lateral strike-slip fault. This movement results in a 0-degree slip angle, as the relative motion is in the opposite direction when compared to the reference point on the other side of the fault*
