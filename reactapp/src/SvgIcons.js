...
export function AlignStartIcon({ className }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16"strokeWidth={1.5} stroke="currentColor" className={"icon" + " " + className}>
...
export function SaveIcon({ className }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" className={"icon" + " " + className}>
            <path d="M11 2H9v3h2z"/>
...
export function InstagramIcon({ className }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" className={"icon" + " " + className}>
