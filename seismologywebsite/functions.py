...
def validate_seismic_file(seismic_file, check_total_traces=True, check_empty_traces=True, check_fs_dt=True, check_equal_parameters=True, check_numbers=True, check_total_number_of_npts=True):
