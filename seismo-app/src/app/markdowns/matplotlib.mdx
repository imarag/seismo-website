...
![A Matplotlib Figure container with a single Axes plot](/img/matplotlib_empty_figure.png)
...
![Matplotlib Figure container with a grid of 2 rows and 3 columns](/img/matplotlib_figure_grid.png)
...
![Matplotlib Figure container with a grid of 2 rows and 3 columns with adjusted layout](/img/matplotlib_figure_grid_tight_layout.png)
...
![Fourier Spectra data imported as a Pandas dataframe object](/img/pandas_fourier_dataframe.png)
*Fourier Spectra data imported as a Pandas dataframe object*
...
![Fourier Spectra of the record](/img/fourier_data_plot.png)
...
![Edit title and axis labels](/img/fourier_data_plot_labels.png)
...
![Edit axis ticks and grid style](/img/fourier_data_plot_grid_ticks.png)
...
![style the legend of the graph](/img/fourier_data_plot_legend.png)
...
![Time series of the recording happened on 24 of July, 2015 at the KRL1 station](/img/matplotlib_mseed_plot.png)
*Time series vs acceleration values for each of the three components*
...
![matplotlib ax h and ax v line function](/img/arrivals.png)
...
![matplotlib fill between x function](/img/windows.png)
...
![matplotlib subplot mosaic function](/img/subplot_mosaic.png)
