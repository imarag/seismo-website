...
![tectonic plates](/img/tectonic-plates.png)
...
![seismic fault](/img/fault-animation.gif)
...
![Propagation of P waves](/img/p-waves.gif)
...
![Propagation of SH waves](/img/sh-waves.gif)
*Propagation of SH waves*

![Propagation of SV waves](/img/sv-waves.gif)
...
![Propagation of Love Waves](/img/love-waves.gif)
*Propagation of Love Waves*

![Propagation of Rayleigh Waves](/img/rayleigh-waves.gif)
...
![Seismic waves generation](/img/source-medium-station.png)
...
![seismic phases](/img/seismic-phases.png) 
...
![A fault is assumed to be a planar surface](/img/fault-type-general.png)
...
![The geometry of a seismic fault](/img/fault-geometry.png)
...
![Normal slip faulting](/img/normal-slip-fault.gif)
*Normal slip faulting. The hanging wall moves downwards relative to the foot wall in which the slip angle is 270 degrees*
...
![Reverse slip faulting](/img/reverse-slip-fault.gif)
*Reverse slip faulting. The hanging wall moves upwards relative to the foot wall in which the slip angle is 90 degrees*
...
![Left-lateral strike-slip fault](/img/strike-slip-fault.gif)
